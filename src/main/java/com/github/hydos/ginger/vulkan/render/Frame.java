package com.github.hydos.ginger.vulkan.render;
...
public class Frame {
	...
	public static void drawFrame() {
		...
		try(MemoryStack stack = stackPush()) {
			...
			VKUBOManager.updateProjAndViewUniformBuffer(VKVariables.currentImageIndex, null);//TODO: move this to entitiy renderer and update before every entity is drawn
